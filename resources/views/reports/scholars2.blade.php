...
<body>
    ...
    <div class="footer">
        ...
        <table style="margin-top: -5px; border-bottom-style: hidden; border-right-style: hidden; border-top-style: hidden; border-left-style: hidden;">
            <tr>
                <td style="border-left-style: hidden; width: 50%; text-align: right; font-size: 9px;">RGN-REPO 2</td>
            </tr>
        </table>
    </div>
    ...
    <div class="content">
        <table style="border: hidden; font-size: 10px; width: 40%">
            <tbody>
                <tr>
                    <td width="30%" style="border: hidden; padding: 1px;">RGN-REPO 2 : </td>
        ...
        <table style="border: 1px solid black; font-size: 8px; margin-top: 20px;">
            <thead style="background-color:#c8c8c8; padding: 5px; font-size: 8px; text-transform: uppercase;">
                <tr>    
                    ...
                    <th style="vertical-align: middle;" width="12%">Level</th>
                    <th style="vertical-align: middle;" width="12%">School</th>
                    <th style="vertical-align: middle;" width="12%">Course</th>
                    <th style="vertical-align: middle;" width="12%">Started</th>
                    <th style="vertical-align: middle;" width="12%">Duration</th>\
                    <th style="vertical-align: middle;" width="12%">Status</th>
                    <th style="vertical-align: middle;" width="12%">Remarks</th>
                </tr> 
            </thead>
        </table>
    </div>
