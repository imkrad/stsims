                            ...
                            <div class="col-md-12">
                                <div class="row g-2" v-if="type == 'Update Qualifier'">
                                    <div class="col-md-12 mb-2">
                                        <div class="alert alert-info mb-xl-0" role="alert">Updating the qualifier status to <b>"Not Availing"</b> or <b>"Deferment".</b></div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row g-2" v-if="type == 'Add Qualifier'">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <Multiselect class="form-control" @search-change="fetchSchools"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <Multiselect class="form-control"
                                            placeholder="Select Course" label="name" 
        ...
        fetchSchools(code){
            axios.get('/search',{
                params: {
                    option: 'schools',
                    code: code,
                    agency: this.$page.props.user.data.assigned_agency_id,
                }
            })
            .then(response => {
