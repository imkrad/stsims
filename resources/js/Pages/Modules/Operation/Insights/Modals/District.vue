<template>
    <b-modal v-model="showModal" hide-footer :title="province.name" class="v-modal-custom" modal-class="zoomIn" fullscreen>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card overflow-hidden shadow-none"><!----><!----><div class="card-body bg-soft-danger"><!----><!----><div class="d-flex align-items-center"><div class="flex-shrink-0"><div class="avatar-sm"><div class="avatar-title bg-soft-danger text-danger rounded-circle fs-17"><i class="ri-gift-line"></i></div></div></div><div class="flex-grow-1 ms-3"><h6 class="fs-16">STSIMS</h6><p class="text-muted mb-0">TESTING.</p></div></div><div class="mt-3 text-end"><a class="btn btn-danger" href="#!" target="_self">test</a></div></div><!----><!----></div>
