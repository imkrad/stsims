<template>
    <b-modal v-model="showModal" header-class="p-3 bg-light" :title="(editable) ? 'Update Privilege' : 'Create Privilege'" class="v-modal-custom" modal-class="zoomIn" centered no-close-on-backdrop>
                ...
                <BCol lg="12">
                    ...
                    <div>
                        <BRow class="g-3">
                            ...
                            <BCol lg="8"  style="margin-top: 13px; margin-bottom: -12px;" class="fs-12" :class="form.errors.is_fixed ? 'text-danger' : ''">Is fixed?</BCol>
                            ...
                            <BCol lg="12"><hr class="text-muted mt-n1 mb-n3"/></BCol>
                            <BCol lg="8"  style="margin-top: 13px; margin-bottom: -12px;" class="fs-12" :class="form.errors.is_reimburseable ? 'text-danger' : ''">Is reimburseable?</BCol>
                            <BCol lg="4"  style="margin-top: 13px; margin-bottom: -12px;">
                               <div class="row">
                                    <div class="col-md-6">
                                        <div class="custom-control custom-radio mb-3">
