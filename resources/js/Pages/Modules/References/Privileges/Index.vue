<template>
    <PageHeader title="Privileges" pageTitle="List" />
            ...
            <b-row class="g-2 mb-2 mt-n2">
                <b-col lg>
                    <div class="input-group mb-1">
                        ...
                        <input type="text" v-model="filter.keyword" placeholder="Search Privilege" class="form-control" style="width: 100px;">
...
export default {
    components: { PageHeader, Pagination, Create, Activation },
    data(){
        return {
