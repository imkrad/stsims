<template>
    <PageHeader title="Barangays" pageTitle="Location" />
            ...
            <b-row class="g-2 mb-2 mt-n2">
                <b-col lg>
                    <div class="input-group mb-1">
                        ...
                        <Multiselect class="white" style="width: 15%;" :options="municipalities" v-model="filter.municipality" label="name" :searchable="true" placeholder="Select Municipality" />
                ...
                <table class="table table-nowrap align-middle mb-0">
                    ...
                    <tbody>
                        <tr v-for="(list,index) in lists" v-bind:key="index" :class="[(list.is_active == 0) ? 'table-warnings' : '']">
                            ...
                            <td class="text-center" v-if="list.district">{{list.district}}</td>
                            <td class="text-center" v-else><span class="text-muted">District not specified</span></td>
                            <td class="text-center">{{list.municipality.name}}</td>
                            <td class="text-center">{{list.municipality.province.name}}</td>
                            <td class="text-center">{{list.municipality.province.region.region}}</td>
                            <td class="text-end">
